...
<div class="w-full h-screen bg-gradient-to-r from-blue-200 to-cyan-200 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">MY EcoMMers</span></h1>
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Browse Popular
...
<div class="bg-orange-200 py-20">
  ...
  <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <a class="group flex flex-col bg-white border shadow-sm rounded-xl
        ...
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              ...
              alt="$category->image">
              <div class="ms-3">
                <h3 class="group-hover:text-blue-600 font-semibold 
                text-gray-800 dark:group-hover:text-gray-400 dark:text-gray-200">
                  {{$category->name}}
                </h3>
              </div>
            </div>
...
<!-- category section end  here -->
   ...
   <!-- castomer review section start  here -->
...
<section class="py-14 font-poppins dark:bg-gray-800">
 ...
 <!-- castomer review section end  here -->
