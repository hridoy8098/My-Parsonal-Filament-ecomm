          ...
          <form wire:submit.prevent='save'>
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                    ...
                    aria-hidden="true">
                      <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 
              ...
              <div>
                ...
                <div class="relative">
                  <input type="email" id="email" wire:model="email" class="py-3 px-4 block w-full
                   border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500
              ...
              <div>
                ...
                <div class="relative">
                  <input type="password" id="password" wire:model="password" class="py-3 border px-4
